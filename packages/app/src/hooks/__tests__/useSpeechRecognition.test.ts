...
describe('useSpeechRecognition', () => {
  ...
  beforeEach(() => {
    ...
    (globalThis as unknown as { SpeechRecognition: unknown }).SpeechRecognition = vi.fn(function () { return mockRecognition });
    (globalThis as unknown as { webkitSpeechRecognition: unknown }).webkitSpeechRecognition = vi.fn(function () { return mockRecognition });
