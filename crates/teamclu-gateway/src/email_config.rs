...
pub struct EmailConfig {
    ...
    /// Example: if base mailbox is teamclu@ai.com and alias is "agen",
    /// only messages addressed to teamclu+agen@ai.com are processed.
    ...
    /// e.g., "TeamClu Agent" will appear as: "TeamClu Agent <user+agent@gmail.com>"
