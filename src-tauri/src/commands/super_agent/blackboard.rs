...
/// Phase 1: `Registry`. Phase 2: `TaskBoard`. Phase 3: `Knowledge`. Phase 4: `Debates`.
...
impl Blackboard {
    ...
    pub fn new(storage_path: PathBuf) -> Self {
        ...
        let board_types = [BoardType::Registry, BoardType::TaskBoard, BoardType::Knowledge, BoardType::Debates];
